...
export const pageElement = {
    ...
    firstProduct: ":nth-child(1) > .product-item-info > .product-item-photo > .product-image-container > .product-image-wrapper > .product-image-photo",
    secondProduct: ":nth-child(2) > .product-item-info > .photo > .product-image-container > .product-image-wrapper > .product-image-photo",
    ...
    colorOption1: "#option-label-color-93-item-60",
    colorOption2: "#option-label-color-93-item-57",
    colorOption3: "#option-label-color-93-item-50",
    colorOption4: "#option-label-color-93-item-53",
    colorOption5: "#option-label-color-93-item-54",
    colorOption6: "#option-label-color-93-item-59",
    quantity: "#qty",
    ...
    acceptDeletion: ".action-primary.action-accept",
    // emptyCartDiv: ".cart-empty > :nth-child(2)",
    emptyCartDiv: ".counter.qty.empty",
